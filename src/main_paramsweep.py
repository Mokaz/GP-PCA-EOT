...
if __name__ == "__main__":
    ...
    for method in method_list:
        ...
        # config.sim.name = f"casestudy_verylarge_added_Q_noise_{method}_{config.sim.seed}_tracker_lidarstd_{tracker_cfg.lidar_std_dev}"
        config.sim.name = f"casestudy_highlidarstd_{method}_{config.sim.seed}_tracker_lidarstd_{tracker_cfg.lidar_std_dev}"
