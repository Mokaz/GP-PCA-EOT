...
class CostLandscapeComponent(pn.viewable.Viewer):
    ...
    def _plot_2d_landscape(self, x_param, y_param, rng, res, center_mode, scale_mode, _trigger, x=None, y=None):
        self._get_frame_data()
    ...
    def __panel__(self):
        ...
        return pn.Row(
            sidebar,
            pn.Column(tabs, pn.pane.HoloViews(dmap_geometry, backend='bokeh'))
        )